      ...
      <section className="relative text-white py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="relative overflow-hidden rounded-3xl bg-neutral-800 border border-white/10 p-6 sm:p-10 shadow-xl">
              <div className="relative space-y-12">
                <header className="space-y-4">
                  <h1 className="text-4xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-orange-400">Frequently Asked Questions</h1>
                ...
                <section className="space-y-3">
                  ...
                  <p className="text-neutral-300">
                    ...
                    <a href="/pricing" className="text-orange-400 underline">
                      pricing page
                    </a>
                    .
                  </p>
                ...
                <section className="space-y-3">
                  ...
                  <p className="text-neutral-300">
                    ...
                    <a href="/revisions" className="text-orange-400 underline">
                      revision policy
                    </a>
                ...
                <section className="space-y-3">
                  ...
                  <p className="text-neutral-300">
                    Simply{" "}
                    <a href="/contact" className="text-orange-400 underline">
                      contact us
                    </a>{" "}
