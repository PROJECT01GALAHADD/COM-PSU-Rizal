...
export const metadata: Metadata = {
  title: "Terms and Conditions — COM",
  description: "Terms and conditions for COM 3D animation services.",
  robots: {
    index: false,
    follow: false,
    noarchive: true,
            ...
            <div className="relative overflow-hidden rounded-3xl border border-neutral-800 bg-[#0f0f0f] p-6 sm:p-10 shadow-xl">
              ...
              <div className="relative space-y-12">
                <header className="space-y-4">
                  <h1 className="text-4xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-orange-400">Terms and Conditions</h1>
                  <p className="text-neutral-400 text-lg">
                    Welcome to COM. By accessing our website, you agree to these terms and conditions. Please read
                    them carefully.
                  </p>
                </header>
                ...
                <section className="space-y-3">
                  ...
                  <p className="text-neutral-300">
                    These Terms and Conditions govern your use of the COM website and services. By using our
                ...
                <section className="space-y-3">
                  ...
                  <p className="text-neutral-300">
                    Unless otherwise stated, COM owns all the project files. This includes all electronic files,
                    drawings, source files, and any materials provided to the client, which remain the sole property of
                    COM International, even if shared.
                  </p>
                ...
                <section className="space-y-3">
                  ...
                  <p className="text-neutral-300">
                    COM will not be liable for any direct, indirect, or consequential loss or damage arising under
                    ...
                    <Link href="/revisions" className="text-orange-400 underline">
                      revision policy
                    </Link>
                    .
                  </p>
                ...
                <section className="space-y-3">
                  ...
                  <p className="text-neutral-300">
                    Email:{" "}
                    <a href="mailto:hello@theCOM.com" className="text-orange-400 underline">
                      hello@theCOM.com
                    </a>
                  </p>
                </section>
