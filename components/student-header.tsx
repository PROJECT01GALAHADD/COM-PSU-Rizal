...
export function StudentHeader({ }: StudentHeaderProps) {
  ...
  const menuItems = [
    ...
    { href: '/student/block-1', label: 'Block 1', icon: Calendar },
    { href: '/student/block-2', label: 'Block 2', icon: Calendar },
      ...
      <div className="container mx-auto max-w-7xl">
        <div className="flex h-14 items-center justify-between px-6 liquid-glass-header rounded-full">
          ...
          <div className="lg:hidden">
            <MobileStudentNav menuItems={menuItems} onLogout={handleLogout} />
          </div>
        </div>
      </div>
    </header>
